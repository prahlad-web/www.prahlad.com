...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/prahlad-shukla-b27542385/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "Corematrix",
    icon: Instagram,
    url: "https://www.instagram.com/_corematrix_0?utm_source=qr&igsh=bzhqc3Q3eTczb3F4",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "Prahlad Shukla",
    icon: Youtube,
    // url: "https://www.youtube.com/@PrahladShukla-h4k",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "Prahlad-Web",
    icon: Github,
    // url: "https://github.com/prahlad-web",
    color: "#ffffff",
